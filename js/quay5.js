(function($) {
    ...
    function checkPhone(obj) {
        ...
        if (mobile !== '') {
            if (vnf_regex.test(mobile) == false) {
                obj.next().html('Sá»‘ Ä‘iá»‡n thoáº¡i khÃ´ng há»£p lá»‡.').show();
                return false;
            } else {
                obj.next().hide();
                return true;
            ...
            obj.next().html('Vui lÃ²ng nháºp sá»‘ Ä‘iá»‡n thoáº¡i.').show();
            return false;
        }
    }
    ...
    function checkEmail(obj) {
        if (obj.val() == "") {
            obj.next().html('Vui lÃ²ng nháºp Ä‘á»‹a chá»‰ email.').show();
            return false;
        }
        if (!validateEmail(obj.val())) {
            obj.next().html('Äá»‹a chá»‰ mail khÃ´ng há»£p lá»‡.').show();
            return false;
        } else {
            obj.next().hide();
            return true;
