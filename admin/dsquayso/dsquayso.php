                ...
                <table class="table table-bordered bg-primary ">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><a  class = 'delete'  id ='delete' href= 'dsquayso/delete.php?userid=$row[userName]' onclick='ConfirmDelete()' ><button class ='btn btn-danger btn-sm'>Xóa</button></a></td> ";
                            echo "<td><a  class = ''  id ='' href= 'dsquayso/edit.php?userid=$row[userName]'  ><button class ='btn btn-success btn-sm'>Sửa</button></a></td> ";
                            echo "</tr>";
                            $stt = $stt + 1;
                        }
                    }
