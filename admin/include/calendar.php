			...
			<form class="form-horizontal" method="POST" action="calendar/addEvent.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="title" class="col-sm-2 control-label">Tên Sự Kiện</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <option value="">Chọn</option>
						  <option style="color:#0071c5;" value="#0071c5">&#9724; Xanh Dương</option>
						  <option style="color:#40E0D0;" value="#40E0D0">&#9724; Trắng</option>
						  <option style="color:#008000;" value="#008000">&#9724; Xanh Lục</option>						  
						  <option style="color:#FFD700;" value="#FFD700">&#9724; Vàng</option>
						  <option style="color:#FF8C00;" value="#FF8C00">&#9724; Cam</option>
						  <option style="color:#FF0000;" value="#FF0000">&#9724; Đỏ</option>
						  <option style="color:#000;" value="#000">&#9724; Đen</option>
						</select>
					</div>
				  </div>
				  <div class="form-group">
			  ...
			  <div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary">Lưu L</button>
			  </div>
			</form>
			</div>
		  </div>
