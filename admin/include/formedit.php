...
<body>
  <form name="myform" method="post" onsubmit="return checkinput();">
                <legend>
                    ...
                    <input value="<?php echo $pass ?>" type="text" id="password" name='password' placeholder='Mật Khẩu' class="form-control" />
                    <strong>Họ Và Tên</strong>
                    <input value="<?php echo $name ?>" type="text" id="hoten" name='hoten' placeholder='Tên' class="form-control" />
                    <strong>Email</strong>
                    <input value="<?php echo $email ?>" type="text" id="email" name='email' placeholder='Email' class="form-control" />
                    <strong>Địa Chỉ</strong>
                    <input value="<?php echo $add ?>" type="text " id="diachi" name='diachi' placeholder='Địa Chỉ' class="form-control" />
                    <strong>Lượt Quay</strong>
                    <input value="<?php echo $luot ?>" type="text" id="luot" name='luot' placeholder='Lượt Quay' class="form-control" />
                    <br>
                </legend>
